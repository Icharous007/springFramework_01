...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	public T findUniqueByProperty(Class<T> entidade, Object valor, String atributo, String condicional) throws Exception {
		validaSessionFactory();
		StringBuilder query = new StringBuilder();
		query.append("SELECT entity FROM ").append(entidade.getSimpleName())
		.append(" entity WHERE entity.").append(atributo).append(" ='").append(valor).append("' ").append(condicional);
