...
public class ReportUtil implements Serializable {
	...
	public StreamedContent geraRelatorio(List<?> listDataBeanColletionReport, Map<String, Object> parametrosRelatorio,
		 ...
		 * caminhoRelatorio.isEmpty()) || !file.exists() ){ caminhoRelatorio =
		 * this.getClass().getResource(FOLDER_RELATORIOS).getPath(); SEPARATOR = ""; }
		 */
		...
		/* caminho completo até o relat�rio compilado indicado */
		String caminhoArquivoJasper = caminhoRelatorio + SEPARATOR + nomeRelatorioJasper + PONTO + "jrxml";

		/* Faz o carregamento do relatorio indicado */
		// JasperReport relatorioJasper = (JasperReport)
		// JRLoader.loadObjectFromFile(caminhoArquivoJasper);
